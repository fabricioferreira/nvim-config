...
return require("packer").startup(function(use)
	...
	-- Kotlin development
	use({ "mfussenegger/nvim-jdtls" }) -- Java/Spring Tooling
	use({ "nvimtools/none-ls.nvim" }) -- optional extra formatters/linters
	use({ "folke/neodev.nvim" }) -- Lua dev for configuring plugins
